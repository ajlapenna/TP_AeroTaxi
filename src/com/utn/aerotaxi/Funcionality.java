...
public class Funcionality {
    ...
    public double insertTicketCost(int numberOfPassengers, ECities departureCity, LocalDate departingDate, int distance) {
    ...
    public boolean createFlightTicket(FlightTicket newFlightTicket) {
        ...
        while (newFlightTicket.getTotalTicketCost() == 0) {
            newFlightTicket.setTotalTicketCost(insertTicketCost(newFlightTicket.getNumberOfPassengers(),
